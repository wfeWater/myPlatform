...
<c:if test="${empty userId}">
    ...
    <div class="panel panel-default" id="sidebar2" style="width: 20%;margin:1% 2% 1% 0%;float: right">
        <div class="panel-heading" style="background-color: white;text-align: center">
            <blockquote>
                wfewater
                <small>一个发布信息的服务平台</small>
            </blockquote>
        </div>
        <ul class="list-group" style="width: 100%">
            <li class="list-group-item">
                <a  href="/mypaltform/signin" class="btn btn-primary btn-block">登录</a>
                <a  href="/mypaltform/signup" class="btn btn-default btn-block">注册</a>
            </li>
        </ul>
    </div>
</c:if>
...
<c:if test="${!empty userId}">
    ...
    <div class="panel panel-default" id="sidebar2" style="width: 20%;margin:1% 2% 1% 0%;float: right">
        ...
        <ul class="list-group" style="width: 100%">
            <li class="list-group-item"><a href="/mypaltform/new">创作新主题</a></li>
